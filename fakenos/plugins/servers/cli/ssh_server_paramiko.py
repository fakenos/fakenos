...
class ParamikoSshServer(TCPServerBase):
    ...
    def _load_nos_cli(self, nos: Nos):
        """ Method that handles the creation of the CLI Nos Module. """
        spec = importlib.util.spec_from_file_location("module.name", nos.CLI_FILE)
        module = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(module)
        return getattr(module, nos.DEVICE_NAME)(nos=nos)
